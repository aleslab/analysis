...
con_1_predshape=data{1,1}.predShape; % just predshape for first block in 1 exeprimetal block  which has 4 sub blocks
hold on                              % {1,1}corresponds to first block first field
figure (101)
...
for i= 2:length (con_1_reaction_times);
    ...
    time_diff(i) = (con_1_reaction_times(i)-con_2_reaction_times(i));
...
mean_time_diff=mean(time_diff);% just little examples of variables of interest mean and variance of RT's
variance_con_1.RT=var(con_2_reaction_times);
