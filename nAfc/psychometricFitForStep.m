...
for iGroup = 1:nGroups,
    ...
    if isfield(analysisOptions,'PF') || isempty( analysisOptions.PF)
        PF = analysisOptions.PF;
    else
    ...
    if ~isfield(analysisOptions,'searchGrid') || isempty(analysisOptions.searchGrid)
        ...
        searchGrid.gamma  = linspace(0,.05,61);
    ...
    guessratesfuller = 'constrained';          %Guess rate fixed
