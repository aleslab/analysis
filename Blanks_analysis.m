...
instrCond = []; % ignore omitted cons in this analysis
...
for iPpt = 1:ptbCorgiData.nParticipants,
    ...
    for iPair = 1:length(dataNowCond),
        ...
        responseChose1(trlSelect,iPair,iPpt) = double(respSubset(trlSelect)=='1');
        responseChose1(~trlSelect,iPair,iPpt)= NaN;
        
        responseChose2(trlSelect,iPair,iPpt) = double(respSubset(trlSelect)=='2');
        responseChose2(~trlSelect,iPair,iPpt)= NaN;
        
        responseChose3(trlSelect,iPair,iPpt) = double(respSubset(trlSelect)=='3');
        responseChose3(~trlSelect,iPair,iPpt)= NaN;
...
disp('Percent pressed ''1'' ')
perc1 = squeeze(nanmean(responseChose1(:,:,:)))'


disp('Percent pressed ''2'' ')
perc2 = squeeze(nanmean(responseChose2(:,:,:)))'

disp('Percent pressed ''3'' ')
perc3 = squeeze(nanmean(responseChose3(:,:,:)))'
