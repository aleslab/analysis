...
for i = 1:length(conditionList)
    ...
    if strfind(currCondition, 'driftGrating')
        xlabel('Change in speed on the screen between sections (cm/s)');
    elseif strfind(currCondition, 'lateral')
        xlabel('Change in speed on the screen between sections (cm/s)');
    elseif strfind(currCondition, 'depth')
        xlabel('Change in speed in depth between sections (cm/s)');
    else
        xlabel('Change in speed between sections (cm/s)');
    end
